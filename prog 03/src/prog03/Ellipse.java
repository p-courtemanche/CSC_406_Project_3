...
public class Ellipse extends GraphicObject {
	 ...
	 */
	public Ellipse(float x, float y, float angle, float width, float height,  float red, float green, float blue, float alpha, float vx, float vy, float spin)
	{
	...
	protected void draw_(PApplet app) {
		app.ellipse(0,  0,  width_, height_);
	}
